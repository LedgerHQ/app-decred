...
typedef struct btchip_storage_s {
    ...
    unsigned char btchip_config_valid;
...
#if 0
extern WIDE btchip_storage_t N_real;

#define N_btchip (*(WIDE btchip_storage_t *)PIC(&N_real))
#else
extern btchip_storage_t const N_real;
#define N_btchip (*(volatile btchip_storage_t *)PIC(&N_real))
#endif
