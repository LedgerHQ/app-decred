#include "glyphs.h"
unsigned int const C_blue_badge_btchip_transaction_colors[] = {
  0x00cccccc,
  0x00d8d8d8,
  0x00e9e9e9,
  0x00f9f9f9,
...
unsigned char const C_blue_badge_btchip_transaction_bitmap[] = {
  ...
  0xff,
        ...
        const bagl_icon_details_t C_blue_badge_btchip_transaction = { GLYPH_blue_badge_btchip_transaction_WIDTH, GLYPH_blue_badge_btchip_transaction_HEIGHT, 2, C_blue_badge_btchip_transaction_colors, C_blue_badge_btchip_transaction_bitmap };
