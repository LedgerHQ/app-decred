...
#define UI_BLUE_BACKGROUND(title)                                                             \
    {{BAGL_RECTANGLE, 0x00, 0, 68, 320, 413, 0, 0, BAGL_FILL, COLOR_BG_1, COLOR_BLACK, 0, 0}, \
     NULL,                                                                                    \
     0,                                                                                       \
     0,                                                                                       \
     0,                                                                                       \
...
#define UI_BLUE_BUTTON_SETTINGS(setting_cb)                                                 \
    {                                                                                       \
        {BAGL_RECTANGLE | BAGL_FLAG_TOUCHABLE,                                              \
         ...
         0},                                                                                \
            BAGL_FONT_SYMBOLS_0_SETTINGS, 0, COLOR_APP, COLOR_WHITE, setting_cb, NULL, NULL \
    }
#define UI_BLUE_BUTTON_GO_BACK(back_cb)                                                 \
    {                                                                                   \
        {BAGL_RECTANGLE | BAGL_FLAG_TOUCHABLE,                                          \
         ...
         BAGL_FONT_SYMBOLS_0 | BAGL_FONT_ALIGNMENT_CENTER | BAGL_FONT_ALIGNMENT_MIDDLE, \
         0},                                                                            \
            BAGL_FONT_SYMBOLS_0_LEFT, 0, COLOR_APP, COLOR_WHITE, back_cb, NULL, NULL    \
    }
#define UI_BLUE_ICON(userid, x, y, width, height, icon, bg_color)                                 \
    {                                                                                             \
        {BAGL_ICON, userid, x, y, width, height, 0, 0, BAGL_FILL, 0, bg_color, 0, 0}, icon, 0, 0, \
            0, NULL, NULL, NULL                                                                   \
    }
// Toggle icon should be set/updated within a preprocessor
#define UI_BLUE_TOGGLE(x, y, bg_color)                                                           \
    {                                                                                            \
        {BAGL_ICON, 0x01, x, y, 320, 18, 0, 0, BAGL_FILL, COLOR_BLACK, bg_color, 0, 0}, NULL, 0, \
            0, 0, NULL, NULL, NULL                                                               \
    }
...
#define UI_BLUE_BUTTON_EXIT(exit_cb)                                                      \
    {                                                                                     \
        {BAGL_RECTANGLE | BAGL_FLAG_TOUCHABLE,                                            \
         ...
         BAGL_FONT_SYMBOLS_0 | BAGL_FONT_ALIGNMENT_CENTER | BAGL_FONT_ALIGNMENT_MIDDLE,   \
         0},                                                                              \
            BAGL_FONT_SYMBOLS_0_DASHBOARD, 0, COLOR_APP, COLOR_WHITE, exit_cb, NULL, NULL \
    }
// Displays standard interface for approval: 2 buttons at the bottom of the screen, one to cancel
// and one to proceed
#define UI_BLUE_BUTTONS_REJECT_OR_CONFIRM(reject_text, confirm_text, reject_cb, confirm_cb) \
    {{BAGL_RECTANGLE | BAGL_FLAG_TOUCHABLE,                                                 \
      0x00,                                                                                 \
      40,                                                                                   \
      414,                                                                                  \
...
union {
    ...
    struct {
        // A bip44 path contains 5 elements, which max length in ascii is 10 char + optional quote
        // "'" + "/" + \0"
...
const bagl_element_t ui_settings_blue[] = {
    ...
    UI_BLUE_TEXT(0,
                 ...
                 126,
                 260,
                 "Enable to approve export requests manually",
                 BAGL_FONT_OPEN_SANS_REGULAR_8_11PX,
                 BAGL_FONT_ALIGNMENT_LEFT,
                 COLOR_GRAY,
                 COLOR_BG_1),
...
const bagl_element_t *ui_transaction_blue_cancel_callback(const bagl_element_t *e) {
...
const bagl_element_t *ui_transaction_blue_1_details(const bagl_element_t *e) {
    if (strlen(ui_transaction_blue_values[0]) * BAGL_FONT_OPEN_SANS_LIGHT_16_22PX_AVG_WIDTH >=
        160) {
        // display details screen
        ui_details_init(ui_transaction_blue_details_name[G_ui_transaction_blue_state][0],
                        ui_transaction_blue_values[0],
...
const bagl_element_t *ui_transaction_blue_2_details(const bagl_element_t *e) {
    if (strlen(ui_transaction_blue_values[1]) * BAGL_FONT_OPEN_SANS_REGULAR_10_13PX_AVG_WIDTH >=
        160) {
        ui_details_init(ui_transaction_blue_details_name[G_ui_transaction_blue_state][1],
                        ui_transaction_blue_values[1],
                        ui_transaction_blue_init);
    }
    return 0;
};
...
const bagl_element_t *ui_transaction_blue_3_details(const bagl_element_t *e) {
    if (strlen(ui_transaction_blue_values[2]) * BAGL_FONT_OPEN_SANS_REGULAR_10_13PX_AVG_WIDTH >=
        160) {
        ui_details_init(ui_transaction_blue_details_name[G_ui_transaction_blue_state][2],
                        ui_transaction_blue_values[2],
                        ui_transaction_blue_init);
    }
    return 0;
};
...
const bagl_element_t ui_transaction_blue[] = {
    ...
    {{BAGL_RECTANGLE,
      ...
      COLOR_BG_1,
      0,
      0},  // WHY OVER ACTIVATE WHE TOUCING OUT OF RECTANGLE ? ASK OTO
     NULL,
     0,
     0x41CCB4,
     0,
    ...
    UI_BLUE_BUTTONS_REJECT_OR_CONFIRM("REJECT",
                                      "CONFIRM",
...
const bagl_element_t *ui_transaction_blue_prepro(const bagl_element_t *element) {
    copy_element_and_map_coin_colors(element);
    ...
    if ((element->component.type & (~BAGL_FLAG_TOUCHABLE)) == BAGL_NONE) {
        ...
        switch (element->component.userid & 0xF0) {
            ...
            // TITLE
            case 0x60:
                tmp_element.text = ui_transaction_blue_details_name[G_ui_transaction_blue_state][3];
                return &tmp_element;
                break;

            // SUBLINE
            case 0x50:
                tmp_element.text = ui_transaction_blue_details_name[G_ui_transaction_blue_state][4];
                return &tmp_element;
                break;
            ...
            case 0x10:
                ...
                tmp_element.text = ui_transaction_blue_values[(element->component.userid & 0xF)];

                // x -= 18 when overflow is detected
                if (strlen(ui_transaction_blue_values[(element->component.userid & 0xF)]) *
            ...
            case 0x30:
                return ui_transaction_blue_details_name[G_ui_transaction_blue_state]
                                                       [element->component.userid & 0xF] != NULL
                           ? &tmp_element
                           : NULL;
        }
    }
...
const bagl_element_t ui_display_derivation_warning[] = {
    ...
    UI_BLUE_TEXT(0,
                 ...
                 314,
                 320,
                 vars.tmp_warning.derivation_path + 30,
                 BAGL_FONT_OPEN_SANS_SEMIBOLD_11_16PX,
                 BAGL_FONT_ALIGNMENT_CENTER,
                 COLOR_BLACK,
                 COLOR_BG_1),
    UI_BLUE_TEXT(0,
                 ...
                 331,
                 320,
                 vars.tmp_warning.derivation_path + 60,
                 BAGL_FONT_OPEN_SANS_SEMIBOLD_11_16PX,
                 BAGL_FONT_ALIGNMENT_CENTER,
                 COLOR_BLACK,
                 COLOR_BG_1),
    UI_BLUE_TEXT(0,
                 ...
                 348,
                 320,
                 vars.tmp_warning.derivation_path + 90,
                 BAGL_FONT_OPEN_SANS_SEMIBOLD_11_16PX,
                 BAGL_FONT_ALIGNMENT_CENTER,
                 COLOR_BLACK,
                 COLOR_BG_1),
...
void ui_transaction_full_blue_init(void) {
    ui_transaction_blue_ok = (bagl_element_callback_t) io_seproxyhal_touch_verify_ok;
    ui_transaction_blue_cancel = (bagl_element_callback_t) io_seproxyhal_touch_verify_cancel;
...
void ui_message_signature_blue_init(void) {
    ...
    ui_transaction_blue_cancel =
        (bagl_element_callback_t) io_seproxyhal_touch_message_signature_verify_cancel;
