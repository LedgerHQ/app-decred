...
"01" + "%0.2X" % len(trusted_input_1) + hexlify(trusted_input_1).decode("utf-8") + "00" + "19",  # trusted input flag + [magic + 00 + rand(2) + input txid + input index + amount + HMAC] + tree + script len
"76a914fdeea9711e6c81027d677b2ceddf5c14d84977d288acffffffff", # spend output script + sequence
"01" + "%0.2X" % len(trusted_input_2) + hexlify(trusted_input_2).decode("utf-8") + "00" + "00",  # trusted input flag + [magic + 00 + rand(2) + input txid + input index + amount + HMAC] + tree + script len
...
# 3045022100ce8f37f615e60bd604b5c2e78a64068e0fc00a2fd06932060f27bc1e804ba90b02204f72ae4161f8935504d04242a5841b45e8f2776c22655aa3ac7f430f196af038 01  witness signature + sighash flag
...
packets = [
"0100000002",#version + number of input
"01" + "%0.2X" % len(trusted_input_1) + hexlify(trusted_input_1).decode("utf-8") + "00" + "00",  # trusted input flag + [magic + 00 + rand(2) + input txid + input index + amount + HMAC] + tree + script len
"ffffffff", # spend output script + sequence
"01" + "%0.2X" % len(trusted_input_2) + hexlify(trusted_input_2).decode("utf-8") + "00" + "19",  # trusted input flag + [magic + 00 + rand(2) + input txid + input index + amount + HMAC] + tree + script len
...
# 3144022041b371311dc2f2dc72b83e8249d3fc0f53f6bfc9ccdb214eeea7b35914ba187602200de4313f2dca0aa2ca857afb65e06d693128e6e4b9b127eff018ddcfe98c462e 01 witness signature + sighash flag
